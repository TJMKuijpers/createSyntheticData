...
def create_gsva_data():
    gsva_geneset=pl.read_csv(os.path.join(os.getcwd(),'syntethic_data/genesets.gmt'),separator='\t',has_header=False).select('column_1')
    ...
    gsva_pvalue_df.write_csv(os.path.join(os.getcwd(), 'syntethic_data/data_gsva_pvalues.txt'), separator="\t")
    gsva_scores_df.write_csv(os.path.join(os.getcwd(), 'syntethic_data/data_gsva_scores.txt'), separator="\t")
