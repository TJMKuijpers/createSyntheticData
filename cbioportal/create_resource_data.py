...
def create_resource_data():
    patient_ids = get_patient_or_sample_identifiers(os.path.join(os.getcwd(),'syntethic_data/data_clinical_patient.txt'),sep='\t', select_column='PATIENT_ID')["PATIENT_ID"].to_list()
    ...
    sample_patient_ids = get_patient_or_sample_identifiers(os.path.join(os.getcwd(), 'syntethic_data/data_clinical_sample.txt'),sep='\t', select_column=['PATIENT_ID', 'SAMPLE_ID'])
    ...
    sample_resource_df.write_csv(os.path.join(os.getcwd(),'syntethic_data/resouce_data_sample.txt'), separator="\t")
    patient_resource_df.write_csv(os.path.join(os.getcwd(), 'syntethic_data/resouce_data_patient.txt'), separator="\t")
